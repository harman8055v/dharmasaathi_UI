...
import { Accordion, AccordionItemWrapper, AccordionTrigger, AccordionContent } from "@/components/ui/accordion-simple"
        ...
        <div className="mx-auto max-w-3xl">
          <Accordion type="single" collapsible className="w-full">
            {faqItems.map((item, index) => (
              <AccordionItemWrapper key={index} value={`item-${index}`}>
