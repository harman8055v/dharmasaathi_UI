    ...
    <section id="signup-form" className="relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-32">
      ...
      <div className="absolute inset-0">
        ...
        <FloatingOrb
          ...
          size="w-64 h-64"
          color="bg-gradient-to-r from-purple-100/30 to-rose-100/20"
          delay={2000}
        />

        {/* Floating Shapes */}
        <FloatingShape className="top-32 right-1/4" delay={500} />
        <FloatingShape className="bottom-32 left-1/3" delay={1500} />
        <FloatingShape className="top-2/3 right-1/3" delay={2500} />
      </div>
