        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground">We work with trusted partners to enhance your experience</p>
            </div>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-4">
                    We use Google Analytics and similar services to understand how our platform is used. These services
              ...
              <CardContent className="p-8 space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">
                      Use our cookie preference center to control which types of cookies you allow. You can access this
                      through your account settings or the cookie banner.
                    </p>
                    <Button className="bg-primary hover:bg-primary/90">Manage Cookie Preferences</Button>
                  </div>
                ...
                <div className="bg-amber-50 border border-amber-200 p-6 rounded-lg">
                  ...
                  <p className="text-amber-700">
                    Disabling essential cookies may affect the functionality of DharmaSaathi. Some features may not work
                    properly, and you may need to re-enter information each time you visit.
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              We're here to help you understand how cookies work and how to manage your preferences. Contact our privacy
              team for any questions about our cookie practices.
            </p>
            <div className="space-y-4">
              <p className="text-lg">
