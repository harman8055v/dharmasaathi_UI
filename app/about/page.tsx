              ...
              <CardContent className="p-8 md:p-12">
                <div className="text-center space-y-6">
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    At DharmaSaathi, we believe that true love transcends the physical realm and finds its foundation in
                    spiritual alignment. Our mission is to create a sacred space where conscious individuals can connect
                    with their divine counterpart, fostering relationships built on shared values, spiritual growth, and
                    mutual respect for the journey of awakening.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="text-lg leading-relaxed">
                ...
                world, spiritual seekers often struggle to find partners who truly understand their journey. Traditional
                dating platforms focus on surface-level attractions, while spiritual communities often lack the tools
              ...
              <p className="text-lg leading-relaxed">
                ...
                sacred nature of love and the practical realities of modern relationships. They envisioned a space where
                dharma meets technology, where ancient wisdom guides modern connection.
              </p>
