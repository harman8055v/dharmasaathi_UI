              ...
              <CardContent className="p-8 space-y-6">
                ...
                <div className="bg-primary/5 p-6 rounded-lg">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    depending on the severity and frequency of the behavior. We believe in redemption and growth, but we
                    prioritize the safety and well-being of our community.
                  </p>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              These guidelines are living principles that evolve with our community. By following them, you help create
              a sanctuary where authentic spiritual connections can flourish. Thank you for being part of our sacred
              journey.
            </p>
