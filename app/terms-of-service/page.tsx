              ...
              <CardContent className="p-8 space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      You agree to use DharmaSaathi with genuine spiritual intent, seeking meaningful connections based
                      on shared values and conscious living.
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    deletion feature in your settings. Upon termination, your profile will be removed and your data will
                    be deleted according to our Privacy Policy.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    activities, or if we believe your actions harm our community. We will provide notice when possible,
                    but reserve the right to terminate immediately for serious violations.
                  </p>
                </CardContent>
              </Card>
            </div>
