              ...
              <Card className="border-0 shadow-lg">
                <CardContent className="p-8">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    We use your profile information, preferences, and spiritual practices to suggest compatible matches
                    and improve our matching algorithms. This includes analyzing compatibility based on shared values,
                    spiritual paths, and relationship goals.
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto space-y-12">
            <div className="text-center">
              ...
              <p className="text-xl text-muted-foreground">You have complete control over your personal information</p>
            </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground leading-relaxed">
              We're here to help you understand and exercise your privacy rights. Contact our dedicated privacy team for
              any questions or concerns about how we handle your personal information.
            </p>
            <div className="space-y-4">
              <p className="text-lg">
