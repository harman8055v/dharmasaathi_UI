...
import SwipeInterface from "@/components/dashboard/swipe-interface"
...
export default function DashboardPage() {
  ...
  // Check if user is verified (for demo purposes, we'll assume they are if profile is complete)
  const isVerified = profile?.verified || profileCompleteness >= 80
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 pb-24">
      ...
      <main className="pt-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          {isVerified ? (
            /* Verified User - Show Swipe Interface */
            <div className="mb-8">
              <div className="text-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900 mb-2">Discover Your Spiritual Match</h2>
                <p className="text-gray-600">Swipe through verified profiles and find your dharmic partner</p>
              </div>

              <SwipeInterface userProfile={profile} />
            </div>
          ) : (
            /* Unverified User - Show Verification Status */
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-600 italic">
                    🙏 Thank you for your patience and understanding as we work to maintain the highest standards for
          ...
          <div className="mb-8" data-referral-section>
          ...
          {/* Features Preview - Only show for unverified users */}
          {!isVerified && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-orange-100 hover:shadow-xl transition-all duration-300 sm:col-span-2 lg:col-span-1">
                <div className="text-center">
