...
VALUES 
    ('Elite Monthly', 49000, 30, '{"elite_access": true, "personal_concierge": true, "exclusive_events": true}', true),
    ('Elite Quarterly', 129000, 90, '{"elite_access": true, "personal_concierge": true, "exclusive_events": true, "savings": "12%"}', true)
